...
/*
 The acronym SCARY describes assignments and initializations that
...
//put the functionality of the template which does not depend on the template parameters in a non-templated base
class.
